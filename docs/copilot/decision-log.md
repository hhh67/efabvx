...
### ページ詳細化初期 (2025-08-17 夕方)

- `/apps` ページ: アプリ一覧 (56px アイコン + 説明) を追加。トップ概要との差別化開始。
- `/contact` ページ: 共通 `sns` データを再利用し連絡手段一覧を表示。
- `/skills` ページ: カテゴリ別表示計画コメントと段階移植 TODO を明示。

理由:

- トップページ依存を減らし、情報アーキテクチャを階層化 (HIG: Hierarchy)。
